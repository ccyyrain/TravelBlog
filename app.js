...
const viewTrip = require('./routes/viewTrip');
const uploadTrip = require('./routes/uploadTrip');
...
/**google api test***/
// const upload_test = require('./routes/upload_test');
/*****/
...
app.use('/viewTrip', viewTrip);
app.use('/updateReview', updateReview);
app.use('/uploadTrip', uploadTrip);
app.use('/myCollection', myCollection);
app.use('/search_result', search_result);
/*********google api test********/
// app.use('/upload_test', upload_test);
/*****************/
